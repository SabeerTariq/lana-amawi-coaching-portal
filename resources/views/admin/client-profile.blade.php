...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('admin.messages') }}?client_id={{ $client->id }}" 
               class="btn btn-primary" style="background-color: #D2691E !important; border-color: #D2691E !important;">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold" style="color: #D2691E !important;">Client Information</h6>
                </div>
                <div class="card-body text-center">
                    ...
                    <div class="row text-center">
                        <div class="col-6">
                            <h6 style="color: #D2691E !important;">{{ $appointments->count() }}</h6>
                            <small class="text-muted">Appointments</small>
                        </div>
                        <div class="col-6">
                            <h6 style="color: #D2691E !important;">{{ $messages->count() }}</h6>
        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold" style="color: #D2691E !important;">Appointment History</h6>
                </div>
                <div class="card-body">
    ...
    <div class="card shadow">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold" style="color: #D2691E !important;">Recent Messages</h6>
        </div>
        <div class="card-body">
            @if($messages->count() > 0)
                <div class="timeline">
                    @foreach($messages->take(10) as $message)
                        <div class="timeline-item">
                            <div class="timeline-marker {{ $message->sender_type === 'admin' ? 'bg-primary' : 'bg-secondary' }}" 
                                 style="{{ $message->sender_type === 'admin' ? 'background-color: #D2691E !important;' : '' }}"></div>
